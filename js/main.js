...
class Calculator {
  ...
  //quando um operador for clicado depois de especificar um valor, ele será atualizado para o campo do previous operand
  chooseOperation(operation) {
    if (this.currentOperand == "") return;

    //checa se já há algum número no campo de previous operand
  ...
  appendNumber(number) {
    //não permitir que o ponto seja clicado duas vezes
